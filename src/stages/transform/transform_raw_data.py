...
class TransformRawData:
    ...
    def transform(self, extract_contract: ExtractContract) -> TransformContract:
        try:
            trasnformed_information = self.__filter_and_trasnform_data(extract_contract)
    ...
    def __filter_and_trasnform_data(self, extract_contract: ExtractContract) -> List[Dict]:
